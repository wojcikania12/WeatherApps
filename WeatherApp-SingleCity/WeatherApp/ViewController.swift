...
//  WeatherApp
//
//  Created by Ania Wójcik on 31/05/2020.
...
class ViewController: UIViewController {
    ...
    func getWeatherData(){
        let urlString = "https://api.openweathermap.org/data/2.5/onecall?lat=35.685360&lon=139.753372&%20&exclude=hourly,minutely,current&appid=f26652e3f203e7640c4d9ed4a4f74445"
    ...
    func convertDegreeToDirection(degree:Int) -> String{
        ...
        let index = round(Double(degree) / 22.5) + 1
